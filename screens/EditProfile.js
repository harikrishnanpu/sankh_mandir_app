        ...
        <ScrollView style={{ height: '99%', padding: 10 }}>
          <View style={{ width: '98%', justifyContent: 'center', }}>
            ...
            <View style={{ width: 'auto' }}>
              <DropDownPicker
                containerStyle={{ marginBottom: 15, zIndex: 10, backgroundColor: 'grey' }}
                ...
                items={[
                  { label: `Active Status ( Click Here For Active Status )`, value: 'Active' },
                  { label: `InActive Status ( Click Here For InActive Status )`, value: 'Busy' },
                  { label: `If You Select InActive Status You States That You Are Not Willing To Donate Your Blood To Others\n\nIf You Select Active Status You Are Willing To Donate Your Blood To Others Who Want Blood For Medical Conditions `, disabled: true }
                ]}
                setOpen={setDropOpen}
        ...
        <View style={{ height: '95%' }} >
          <ScrollView>
            <View style={{ margin: 10 }}>
              ...
              <View style={{ marginTop: 15, marginBottom: 20, margin: 5, backgroundColor: 'white', borderRadius: 10, padding: 8 }}>
